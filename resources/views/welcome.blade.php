...
<div id="header">
    ...
    <nav role="navigation">
        ...
        <div class="small-logo">
            <span class="text-primary">Functional Test</span>
        </div>
                    ...
                    <div class="row float-e-margins">
                        <div class="col-md-2">
                            <button class="btn btn-block btn-md btn-primary2 text-center" v-on:click="openAddBoardModalWindow()" type="button">
                                ADD COLUMN &nbsp;<i class="fa fa-clipboard"></i>
                            </button>
                        </div>

                        <div class="col-md-2">
                            <button class="btn btn-block btn-md btn-primary2 text-center" v-on:click="openAddItemModalWindow()" type="button">
                                ADD CARD &nbsp;<i class="fa fa-address-card"></i>
                            </button>
                        </div>

                         <div class="col-md-2">
                            <form action="{{ route('our_backup_database') }}" method="get">
                            <button class="btn btn-block btn-md btn-primary2 text-center" type="submit">
                                EXPORT DB &nbsp;<i class="fa fa-download"></i>
                            </button>
